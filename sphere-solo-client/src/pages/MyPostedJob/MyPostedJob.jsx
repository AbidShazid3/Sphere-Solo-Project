...
const MyPostedJob = () => {
    ...
    return (
        <div className='container px-4 mx-auto pt-12 min-h-[calc(100vh-418px)]'>
            <div className='md:flex lg:flex md:flex-row-reverse lg:flex-row-reverse items-center justify-between'>
